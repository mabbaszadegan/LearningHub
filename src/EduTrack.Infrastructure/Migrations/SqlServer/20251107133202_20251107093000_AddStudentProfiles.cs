...
{
    /// <inheritdoc />
    public partial class _20251107093000_AddStudentProfiles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ScheduleItemId_StudentId_ProfileNull",
                table: "Submissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItemStudentAssignment_ScheduleItemId_StudentId_ProfileNull",
                table: "ScheduleItemStudentAssignment",
                columns: new[] { "ScheduleItemId", "StudentId" },
                unique: true,
                filter: "[StudentProfileId] IS NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItemBlockStatistics_StudentId_ScheduleItemId_ProfileNull",
                table: "ScheduleItemBlockStatistics",
                columns: new[] { "StudentId", "ScheduleItemId" },
                filter: "[StudentProfileId] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItemBlockStatistics_StudentId_ScheduleItemId_BlockId_ProfileNull",
                table: "ScheduleItemBlockStatistics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_InteractiveQuestionId_StudentId_ProfileNull",
                table: "StudentAnswers",
