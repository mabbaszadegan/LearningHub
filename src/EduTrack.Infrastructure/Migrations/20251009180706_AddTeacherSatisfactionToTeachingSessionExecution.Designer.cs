...
namespace EduTrack.Infrastructure.Migrations
{
    ...
    [Migration("20251009180706_AddTeacherSatisfactionToTeachingSessionExecution")]
    partial class AddTeacherSatisfactionToTeachingSessionExecution
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduTrack.Domain.Entities.TeachingSessionReport", b =>
                {
                    ...
                    b.Property<string>("StepCompletionsJson")
                        .HasColumnType("nvarchar(max)");
