...
class AccuratePersianDate {
    ...
    // Simple and accurate Gregorian to Persian conversion
    ...
    // Simple and accurate Persian to Gregorian conversion
    ...
    getGregorianDayOfYear(year, month, day) {
        const date = new Date(year, month - 1, day);
        const start = new Date(year, 0, 0);
        return Math.floor((date - start) / 86400000);
    }

    isPersianLeapYear(jYear) {
        const breaks = [
...
window.persianDate = new AccuratePersianDate();
